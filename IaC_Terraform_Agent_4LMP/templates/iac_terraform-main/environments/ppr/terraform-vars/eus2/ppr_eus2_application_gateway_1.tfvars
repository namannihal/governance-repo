...
agw_subnet_id             = "/subscriptions/7b8a8ffb-9be5-4786-8ba6-dd328b9d6857/resourceGroups/a1a-52161-ppr-rg-platform-eus2-01/providers/Microsoft.Network/virtualNetworks/a1a-52161-ppr-vnet-rtbl-eus2-01/subnets/a1a-52161-ppr-snet-appgw-eus2-04"
keyvault_id               = "/subscriptions/7b8a8ffb-9be5-4786-8ba6-dd328b9d6857/resourceGroups/a1a-52161-ppr-rg-estimates-eus2-01/providers/Microsoft.KeyVault/vaults/a1a52161pprkvinfeus201"
private_ip_address        = "10.239.53.5"
...
backend_address_pools = [
  {
    ...
    fqdns        = ["a1a-52161-ppr-app-qdctweb-eus2-01-linux.azurewebsites.net"]
    ip_addresses = null
  },
  {
    name         = "beap-hvpweb-ppr"
    fqdns        = ["a1a-52161-ppr-app-hvpweb-eus2-01-linux.azurewebsites.net"]
    ip_addresses = null
  },
  {
    name         = "beap-guidancebre-ppr"
    fqdns        = ["a1a-52161-ppr-app-guidancebre-eus2-01-linux.azurewebsites.net"]
    ip_addresses = null
  },
  {
    name         = "beap-estimatessdi-ppr"
    fqdns        = ["a1a-52161-ppr-app-estimatessdi-eus2-01-linux.azurewebsites.net"]
    ip_addresses = null
  },
  {
    name         = "beap-estimatesbre-ppr"
    fqdns        = ["a1a-52161-ppr-app-estimatesbre-eus2-01-linux.azurewebsites.net"]
    ip_addresses = null
  },
  {
    name         = "beap-brokerxl-ppr"
    fqdns        = ["a1a-52161-ppr-app-brokerxl-eus2-01-linux.azurewebsites.net"]
    ip_addresses = null
  },
  {
    name         = "beap-broker-ppr"
    fqdns        = ["a1a-52161-ppr-app-broker-eus2-01-linux.azurewebsites.net"]
    ip_addresses = null
  },
  {
    name         = "beap-guidance-ppr"
    fqdns        = ["a1a-52161-ppr-app-guidance-eus2-01-linux.azurewebsites.net"]
    ip_addresses = null
  },
  {
    name         = "beap-collection-ppr"
    fqdns        = ["a1a-52161-ppr-app-collection-eus2-01-linux.azurewebsites.net"]
    ip_addresses = null
  },
  {
    name         = "beap-actualsbre-ppr"
    fqdns        = ["a1a-52161-ppr-app-actualsbre-eus2-01-linux.azurewebsites.net"]
    ip_addresses = null
  }
]
...
http_listeners = [
  # HTTPS listeners for qdct
  {
    ...
    protocol                       = "Https"
    ssl_certificate_name           = "qdct-ppr"
    require_sni                    = true
    listener_type                  = "MultiSite"
    host_names                     = null
    host_name                      = "qdct.ppr.estimates.dbors.internal"
  ...
  # HTTPS listeners for hvpweb
  {
    ...
    frontend_port_name             = "appgateway-feporthttps"
    protocol                       = "Https"
    ssl_certificate_name           = "hvpweb-ppr"
    require_sni                    = true
    listener_type                  = "MultiSite"
    host_name                      = "hvpweb.ppr.estimates.dbors.internal"
    host_names                     = null
    firewall_policy_id             = null
  },
  {
  ...
  # HTTPS listeners for guidancebre
  {
    ...
    frontend_port_name             = "appgateway-feporthttps"
    protocol                       = "Https"
    ssl_certificate_name           = "guidancebre-ppr"
    require_sni                    = true
    listener_type                  = "MultiSite"
    host_name                      = "guidancebre.ppr.estimates.dbors.internal"
    host_names                     = null
    firewall_policy_id             = null
  },
  {
  ...
  # HTTPS listeners for estimatessdi
  {
    ...
    frontend_port_name             = "appgateway-feporthttps"
    protocol                       = "Https"
    ssl_certificate_name           = "estimatessdi-ppr"
    require_sni                    = true
    listener_type                  = "MultiSite"
    host_name                      = "estimatessdi.ppr.estimates.dbors.internal"
    host_names                     = null
    firewall_policy_id             = null
  },
  {
  ...
  # HTTPS listeners for estimatesbre
  {
    ...
    frontend_port_name             = "appgateway-feporthttps"
    protocol                       = "Https"
    ssl_certificate_name           = "estimatesbre-ppr"
    require_sni                    = true
    listener_type                  = "MultiSite"
    host_name                      = "estimatesbre.ppr.estimates.dbors.internal"
    host_names                     = null
    firewall_policy_id             = null
  },
  {
  ...
  # HTTPS listeners for brokerxl
  {
    ...
    frontend_port_name             = "appgateway-feporthttps"
    protocol                       = "Https"
    ssl_certificate_name           = "brokerxl-ppr"
    require_sni                    = true
    listener_type                  = "MultiSite"
    host_name                      = "brokerxl.ppr.estimates.dbors.internal"
    host_names                     = null
    firewall_policy_id             = null
  },
  {
  ...
  # HTTPS listeners for broker
  {
    ...
    frontend_port_name             = "appgateway-feporthttps"
    protocol                       = "Https"
    ssl_certificate_name           = "broker-ppr"
    require_sni                    = true
    listener_type                  = "MultiSite"
    host_name                      = "broker.ppr.estimates.dbors.internal"
    host_names                     = null
    firewall_policy_id             = null
  },
  {
  ...
  # HTTPS listeners for guidance
  {
    ...
    frontend_port_name             = "appgateway-feporthttps"
    protocol                       = "Https"
    ssl_certificate_name           = "guidance-ppr"
    require_sni                    = true
    listener_type                  = "MultiSite"
    host_name                      = "guidance.ppr.estimates.dbors.internal"
    host_names                     = null
    firewall_policy_id             = null
  },
  {
  ...
  # HTTPS listeners for collection
  {
    ...
    frontend_port_name             = "appgateway-feporthttps"
    protocol                       = "Https"
    ssl_certificate_name           = "collection-ppr"
    require_sni                    = true
    listener_type                  = "MultiSite"
    host_name                      = "collection.ppr.estimates.dbors.internal"
    host_names                     = null
    firewall_policy_id             = null
  },
  {
  ...
  # HTTPS listeners for actualsbre
  {
    ...
    frontend_port_name             = "appgateway-feporthttps"
    protocol                       = "Https"
    ssl_certificate_name           = "actualsbre-ppr"
    require_sni                    = true
    listener_type                  = "MultiSite"
    host_name                      = "actualsbre.ppr.estimates.dbors.internal"
    host_names                     = null
    firewall_policy_id             = null
  },
  {
...
ssl_certificates = [
  {
    name                = "qdct-ppr"
    key_vault_secret_id = "https://a1a52161pprkvinfeus201.vault.azure.net/secrets/qdct-ppr"
    data                = null
    password            = null
  },
  {
    name                = "hvpweb-ppr"
    key_vault_secret_id = "https://a1a52161pprkvinfeus201.vault.azure.net/secrets/hvpweb-ppr"
    data                = null
    password            = null
  },
  {
    name                = "guidancebre-ppr"
    key_vault_secret_id = "https://a1a52161pprkvinfeus201.vault.azure.net/secrets/guidancebre-ppr"
    data                = null
    password            = null
  },
  {
    name                = "estimatessdi-ppr"
    key_vault_secret_id = "https://a1a52161pprkvinfeus201.vault.azure.net/secrets/estimatessdi-ppr"
    data                = null
    password            = null
  },
  {
    name                = "estimatesbre-ppr"
    key_vault_secret_id = "https://a1a52161pprkvinfeus201.vault.azure.net/secrets/estimatesbre-ppr"
    data                = null
    password            = null
  },
  {
    name                = "brokerxl-ppr"
    key_vault_secret_id = "https://a1a52161pprkvinfeus201.vault.azure.net/secrets/brokerxl-ppr"
    data                = null
    password            = null
  },
  {
    name                = "broker-ppr"
    key_vault_secret_id = "https://a1a52161pprkvinfeus201.vault.azure.net/secrets/broker-ppr"
    data                = null
    password            = null
  },
  {
    name                = "guidance-ppr"
    key_vault_secret_id = "https://a1a52161pprkvinfeus201.vault.azure.net/secrets/guidance-ppr"
    data                = null
    password            = null
  },
  {
    name                = "collection-ppr"
    key_vault_secret_id = "https://a1a52161pprkvinfeus201.vault.azure.net/secrets/collection-ppr"
    data                = null
    password            = null
  },
  {
    name                = "actualsbre-ppr"
    key_vault_secret_id = "https://a1a52161pprkvinfeus201.vault.azure.net/secrets/actualsbre-ppr"
    data                = null
    password            = null
  }
]
