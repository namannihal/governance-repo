...
storage_account_config = {
  ...
  ec_appsrv = {
    ...
    vm_identity_keys = ["ec_appsrv01", "ec_appsrv02"]
...
linux_vm_config = {
  ec_appsrv01 = {
    ...
    source_image_id                = "/subscriptions/7b8a8ffb-9be5-4786-8ba6-dd328b9d6857/resourceGroups/a1a-52161-ppr-rg-estimates-cus-01/providers/Microsoft.Compute/galleries/a1a52161pprsigvmimagecus01/images/rhel-server-9-standard-x64-a1a52161pprsivmimagecus01/versions/1.0.0"
    os_disk = {
  ...
  ec_appsrv02 = {
    ...
    user_data                      = null
    enable_systemassigned_identity = true
    source_image_id                = "/subscriptions/7b8a8ffb-9be5-4786-8ba6-dd328b9d6857/resourceGroups/a1a-52161-ppr-rg-estimates-cus-01/providers/Microsoft.Compute/galleries/a1a52161pprsigvmimagecus01/images/rhel-server-9-standard-x64-application/versions/1.0.0"
    os_disk = {
      storage_account_type = "Premium_LRS"
      caching              = "ReadWrite"
      disk_size_gb         = "128"
  ...
  ec_ftpsrv01 = {
    ...
    user_data                      = null
    enable_systemassigned_identity = true
    source_image_id                = "/subscriptions/7b8a8ffb-9be5-4786-8ba6-dd328b9d6857/resourceGroups/a1a-52161-ppr-rg-estimates-cus-01/providers/Microsoft.Compute/galleries/a1a52161pprsigvmimagecus01/images/rhel-server-9-standard-x64-application/versions/1.0.1"
    os_disk = {
