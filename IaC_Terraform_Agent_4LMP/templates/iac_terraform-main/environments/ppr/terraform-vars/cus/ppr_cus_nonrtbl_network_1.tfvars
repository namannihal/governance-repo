...
virtual_network_id  = "/subscriptions/7b8a8ffb-9be5-4786-8ba6-dd328b9d6857/resourceGroups/a1a-52161-ppr-rg-shared-cus-01/providers/Microsoft.Network/virtualNetworks/a1a-52161-ppr-vnet-nonrtbl-cus-01"
tags = {
...
routable_rules = {
  route1 = {
    route1 = {
      name                   = "a1a-52161-ppr-route-01"
      address_prefix         = "0.0.0.0/0"
      next_hop_type          = "VirtualAppliance"
      next_hop_in_ip_address = "10.203.116.68"
    }
  }
  route2 = {
    route2 = {
      name                   = "a1a-52161-ppr-route-02"
...
subnets = {
  ...
  ecddb_subnet = {
    context           = "ecddb"
    address_prefix    = "100.69.3.128/26"
    routes            = {}
    service_endpoints = ["Microsoft.Storage", "Microsoft.KeyVault", "Microsoft.ServiceBus", "Microsoft.Web", "Microsoft.Sql", "Microsoft.EventHub"]
    security_rules = {
      rule1 = {
        name                                       = "Microsoft.Sql-managedInstances_UseOnly_mi-healthprobe-in-100-69-3-128-26-v11"
        ...
        destination_address_prefixes               = ["100.69.3.128/26"]
        source_application_security_group_ids      = []
        destination_application_security_group_ids = []
      }
      rule2 = {
        name                                       = "Microsoft.Sql-managedInstances_UseOnly_mi-internal-in-100-69-3-128-26-v11"
        ...
        source_port_range                          = "*"
        destination_port_range                     = "*"
        source_address_prefixes                    = ["100.69.3.128/26"]
        destination_address_prefixes               = ["100.69.3.128/26"]
        source_application_security_group_ids      = []
        destination_application_security_group_ids = []
      }
      ...
      rule5 = {
        name                                       = "Microsoft.Sql-managedInstances_UseOnly_mi-optional-azure-out-100-69-3-128-26"
        ...
        source_port_range                          = "*"
        destination_port_range                     = "443"
        source_address_prefix                      = "100.69.3.128/26"
        destination_address_prefix                 = "AzureCloud"
        source_application_security_group_ids      = []
        destination_application_security_group_ids = []
      }
      rule6 = {
        name                                       = "Microsoft.Sql-managedInstances_UseOnly_mi-aad-out-100-69-3-128-26-v11"
      ...
      rule7 = {
        name                                       = "Microsoft.Sql-managedInstances_UseOnly_mi-onedsc-out-100-69-3-128-26-v11"
      ...
      rule8 = {
        name                                       = "Microsoft.Sql-managedInstances_UseOnly_mi-internal-out-100-69-3-128-26-v11"
      ...
      rule9 = {
        name                                       = "Microsoft.Sql-managedInstances_UseOnly_mi-strg-p-out-100-69-3-128-26-v11"
      ...
      rule10 = {
        name                                       = "Microsoft.Sql-managedInstances_UseOnly_mi-strg-s-out-100-69-3-128-26-v11"
        description                                = "Allow outbound communication with storage over HTTPS"
        priority                                   = 105
        direction                                  = "Outbound"
        access                                     = "Allow"
  ...
  eaddb_subnet = {
    context           = "eaddb"
    address_prefix    = "100.69.11.0/26"
    routes            = {}
    service_endpoints = ["Microsoft.Storage", "Microsoft.KeyVault", "Microsoft.ServiceBus", "Microsoft.Web", "Microsoft.Sql", "Microsoft.EventHub"]
    security_rules = {
      rule1 = {
        name                                       = "Microsoft.Sql-managedInstances_UseOnly_mi-healthprobe-in-100-69-11-0-26-v11"
        description                                = "Allow Azure Load Balancer inbound traffic"
        priority                                   = 100
        direction                                  = "Inbound"
        access                                     = "Allow"
        ...
        destination_port_range                     = "*"
        source_address_prefix                      = "AzureLoadBalancer"
        destination_address_prefix                 = "100.69.11.0/26"
        source_application_security_group_ids      = []
        destination_application_security_group_ids = []
      }
      rule2 = {
        name                                       = "Microsoft.Sql-managedInstances_UseOnly_mi-internal-in-100-69-11-0-26-v11"
        description                                = "Allow MI internal inbound traffic"
        priority                                   = 102
        direction                                  = "Inbound"
        access                                     = "Allow"
        ...
        source_port_range                          = "*"
        destination_port_range                     = "*"
        source_address_prefix                      = "100.69.11.0/26"
        destination_address_prefix                 = "100.69.11.0/26"
        source_application_security_group_ids      = []
        destination_application_security_group_ids = []
      }
      ...
      rule6 = {
        name                                       = "Microsoft.Sql-managedInstances_UseOnly_mi-optional-azure-out-100-69-11-0-26"
        description                                = "Allow AzureCloud outbound https traffic"
        priority                                   = 100
        direction                                  = "Outbound"
        access                                     = "Allow"
      ...
      rule7 = {
        name                                       = "Microsoft.Sql-managedInstances_UseOnly_mi-aad-out-100-69-11-0-26-v11"
        description                                = "Allow communication with Azure Active Directory over https"
        priority                                   = 101
        direction                                  = "Outbound"
        access                                     = "Allow"
      ...
      rule8 = {
        name                                       = "Microsoft.Sql-managedInstances_UseOnly_mi-onedsc-out-100-69-11-0-26-v11"
        description                                = "Allow communication with the One DS Collector over https"
        priority                                   = 102
        direction                                  = "Outbound"
        access                                     = "Allow"
      ...
      rule9 = {
        name                                       = "Microsoft.Sql-managedInstances_UseOnly_mi-internal-out-100-69-11-0-26-v11"
        description                                = "Allow MI internal outbound traffic"
        priority                                   = 103
        direction                                  = "Outbound"
        access                                     = "Allow"
      ...
      rule10 = {
        name                                       = "Microsoft.Sql-managedInstances_UseOnly_mi-strg-p-out-100-69-11-0-26-v11"
        description                                = "Allow outbound communication with storage over HTTPS"
        priority                                   = 104
        direction                                  = "Outbound"
        access                                     = "Allow"
      ...
      rule11 = {
        name                                       = "Microsoft.Sql-managedInstances_UseOnly_mi-strg-s-out-100-69-11-0-26-v11"
        description                                = "Allow outbound communication with storage over HTTPS"
        priority                                   = 105
        direction                                  = "Outbound"
        access                                     = "Allow"
