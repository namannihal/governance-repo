...
privateendpoint_subnet_id   = "/subscriptions/96278378-bea2-4e84-b5a3-4b5459eb2d18/resourceGroups/a1a-52161-dev-rg-shared-eus2-01/providers/Microsoft.Network/virtualNetworks/a1a-52161-dev-vnet-nonrtbl-eus2-01/subnets/a1a-52161-tst-snet-ecpec-eus2-01"
...
storage_account_config = {
  ...
  windows_shared = {
    ...
    vm_identity_keys                       = ["ec_hvprep01", "ec_repsrv01", "ec_tassrv04", "ec_tagsrv01", "ec_hvpmon01", "ea_calcsrv01", "ea_calcsrv02", "ea_calcsrv03", "ea_calcsrv04", "ea_sdisrv01", "ea_pantestsrv01", "ea_rtsubsrv01", "ea_webjobsrv01"]
...
windows_vm = {
  ...
  ea_calcsrv01 = {
    ...
    network_config = {
      use_existing_subnet = true
      subnet_id           = "/subscriptions/96278378-bea2-4e84-b5a3-4b5459eb2d18/resourceGroups/a1a-52161-dev-rg-shared-eus2-01/providers/Microsoft.Network/virtualNetworks/a1a-52161-dev-vnet-nonrtbl-eus2-01/subnets/a1a-52161-tst-snet-eaapp-eus2-01"
    }
    disk_encryption_set = {
      context         = "calcsrv"
      instance        = "01"
