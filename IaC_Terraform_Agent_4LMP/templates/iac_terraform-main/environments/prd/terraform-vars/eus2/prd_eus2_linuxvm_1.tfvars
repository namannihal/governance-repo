...
linux_vm_config = {
  ec_appsrv01 = {
    ...
    username                       = "lsegadmin"
    computer_name                  = "estprdappsrv01"
    vtpm_enabled                   = true
    user_data                      = null
    enable_systemassigned_identity = true
    enable_entra_auth              = true
    source_image_id                = "/subscriptions/ff741a46-f3b9-47fb-a826-3c5acb77a45a/resourceGroups/a1a-52161-prd-rg-prod-eus2-01/providers/Microsoft.Compute/galleries/a1a52161prdsigvmimageeus201/images/rhel-server-9-standard-x64-application/versions/1.0.0"
    os_disk = {
