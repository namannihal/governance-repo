...
agw_subnet_id             = "/subscriptions/ff741a46-f3b9-47fb-a826-3c5acb77a45a/resourceGroups/a1a-52161-prd-rg-platform-eus2-01/providers/Microsoft.Network/virtualNetworks/a1a-52161-prd-vnet-rtbl-eus2-01/subnets/a1a-52161-prd-snet-appgw-eus2-04"
keyvault_id               = "/subscriptions/ff741a46-f3b9-47fb-a826-3c5acb77a45a/resourceGroups/a1a-52161-prd-rg-prod-eus2-01/providers/Microsoft.KeyVault/vaults/a1a52161prdkvinfeus201"
private_ip_address        = "10.117.217.5"
...
backend_address_pools = [
  {
    ...
    fqdns        = ["a1a-52161-prd-app-qdctweb-eus2-01-linux.azurewebsites.net"]
    ip_addresses = null
  },
  {
    name         = "beap-hvpweb-prd"
    fqdns        = ["a1a-52161-prd-app-hvpui-eus2-01-windows.azurewebsites.net"]
    ip_addresses = null
  },
  {
    name         = "beap-guidancebre-prd"
    fqdns        = ["a1a-52161-prd-app-guidbre-eus2-01-windows.azurewebsites.net"]
    ip_addresses = null
  },
  {
    name         = "beap-estimatessdi-prd"
    fqdns        = ["a1a-52161-prd-app-estsdi-eus2-01-windows.azurewebsites.net"]
    ip_addresses = null
  },
  {
    name         = "beap-estimatesbre-prd"
    fqdns        = ["a1a-52161-prd-app-estbre-eus2-01-windows.azurewebsites.net"]
    ip_addresses = null
  },
  {
    name         = "beap-brokerxl-prd"
    fqdns        = ["a1a-52161-prd-app-brkrxlsrv-eus2-01-linux.azurewebsites.net"]
    ip_addresses = null
  },
  {
    name         = "beap-broker-prd"
    fqdns        = ["a1a-52161-prd-app-brkrui-eus2-01-linux.azurewebsites.net"]
    ip_addresses = null
  },
  {
    name         = "beap-guidance-prd"
    fqdns        = ["a1a-52161-prd-app-guidance-eus2-01-linux.azurewebsites.net"]
    ip_addresses = null
  },
  {
    name         = "beap-collection-prd"
    fqdns        = ["a1a-52161-prd-app-collection-eus2-01-linux.azurewebsites.net"]
    ip_addresses = null
  },
  {
    name         = "beap-actualsbre-prd"
    fqdns        = ["a1a-52161-prd-app-actualsbre-eus2-01-windows.azurewebsites.net"]
    ip_addresses = null
  }
]
...
ssl_certificates = [
  {
    name                = "qdct-prd"
    key_vault_secret_id = "https://a1a52161prdkvinfeus201.vault.azure.net/secrets/qdct-prd"
    data                = null
    password            = null
  },
  {
    name                = "hvpweb-prd"
    key_vault_secret_id = "https://a1a52161prdkvinfeus201.vault.azure.net/secrets/hvpweb-prd"
    data                = null
    password            = null
  },
  {
    name                = "guidancebre-prd"
    key_vault_secret_id = "https://a1a52161prdkvinfeus201.vault.azure.net/secrets/guidancebre-prd"
    data                = null
    password            = null
  },
  {
    name                = "estimatessdi-prd"
    key_vault_secret_id = "https://a1a52161prdkvinfeus201.vault.azure.net/secrets/estimatessdi-prd"
    data                = null
    password            = null
  },
  {
    name                = "estimatesbre-prd"
    key_vault_secret_id = "https://a1a52161prdkvinfeus201.vault.azure.net/secrets/estimatesbre-prd"
    data                = null
    password            = null
  },
  {
    name                = "brokerxl-prd"
    key_vault_secret_id = "https://a1a52161prdkvinfeus201.vault.azure.net/secrets/brokerxl-prd"
    data                = null
    password            = null
  },
  {
    name                = "broker-prd"
    key_vault_secret_id = "https://a1a52161prdkvinfeus201.vault.azure.net/secrets/broker-prd"
    data                = null
    password            = null
  },
  {
    name                = "guidance-prd"
    key_vault_secret_id = "https://a1a52161prdkvinfeus201.vault.azure.net/secrets/guidance-prd"
    data                = null
    password            = null
  },
  {
    name                = "collection-prd"
    key_vault_secret_id = "https://a1a52161prdkvinfeus201.vault.azure.net/secrets/collection-prd"
    data                = null
    password            = null
  },
  {
    name                = "actualsbre-prd"
    key_vault_secret_id = "https://a1a52161prdkvinfeus201.vault.azure.net/secrets/actualsbre-prd"
    data                = null
    password            = null
  }
]
