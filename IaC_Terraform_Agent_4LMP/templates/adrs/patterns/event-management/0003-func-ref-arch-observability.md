...
![Functional Design Pattern: Observability](0003-func-ref-arch-observability.assets/image-001.png)
...
<a href="../0004-observability-tech-ref-arch/" class="md-footer__link md-footer__link--next" aria-label="Next: Datadog Integration for Azure Services (Technical Design Pattern)"></a>
