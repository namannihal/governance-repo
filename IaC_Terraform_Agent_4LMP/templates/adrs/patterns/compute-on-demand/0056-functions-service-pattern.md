...
# Azure Functions Service Pattern<a href="#azure-functions-service-pattern" class="headerlink" title="Permanent link">¶</a>
...
See the [Functions-as-a-Service (FaaS) Technology Selection Pattern](../0001-functions-as-a-service/) for further details.
...
<a href="../0001-functions-as-a-service/" class="md-footer__link md-footer__link--prev" aria-label="Previous: AWS Lambda to Azure Functions"></a>
...
<a href="../0070-on-demand-capacity-reservations/" class="md-footer__link md-footer__link--next" aria-label="Next: On-demand capacity reservation"></a>
