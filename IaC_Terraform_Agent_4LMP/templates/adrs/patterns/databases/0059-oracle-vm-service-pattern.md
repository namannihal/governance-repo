...
# Oracle on VM Service Pattern<a href="#oracle-on-vm-service-pattern" class="headerlink" title="Permanent link">¶</a>
...
See [Use of Oracle on Cloud](../0010-oracle/) for more details.

This Service Pattern provides a templated deployment of Oracle on VM including the security and networking services required for common scenarios.
...
<a href="../0057-mysql-flex-server-service-pattern/" class="md-footer__link md-footer__link--prev" aria-label="Previous: Azure Database for MySQL - Flexible Server Service Pattern"></a>
...
<a href="../0072-relational-databases/" class="md-footer__link md-footer__link--next" aria-label="Next: Azure Relational Database Selection"></a>
