...
![Protected Environments](0065-segregation-of-duties.assets/image-001.png)
...
![Using Flux GitOps](0065-segregation-of-duties.assets/image-001.png)
...
## Pattern - Using a Separate Project for Deployments<a href="#pattern-using-a-separate-project-for-deployments" class="headerlink" title="Permanent link">¶</a>
...
<a href="../../distributed-cache/0012-cache/" class="md-footer__link md-footer__link--next" aria-label="Next: Caching options in Azure"></a>
