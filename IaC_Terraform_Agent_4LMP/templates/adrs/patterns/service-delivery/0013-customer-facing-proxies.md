...
![Dog-leg](0013-customer-facing-proxies.assets/image-001.png)
...
<a href="../0019-rdp-api-mitigation/" class="md-footer__link md-footer__link--next" aria-label="Next: RDP API Gateway Dog-Leg - Customer Mitigation (Functional Design Pattern)"></a>
