...
![Protected Environments](img/0035-environment-protection.png)
...
![Using Flux GitOps](img/0035-flux.png)
...
## Anti-Pattern - Using a Separate Project for Deployments
...
- **Bad**, because although the 'Guest' and 'Reporter' roles would prevent a developer from running a pipeline, they
  would also restrict access to other features that require at least the Developer role[^2] such as Merge Request
  reviews
  which may be useful in the context of release preparation.

## Further Reading

[^1]: [Gitlab Deployment Approvals](https://docs.gitlab.com/ee/ci/environments/deployment_approvals.html)
[^2]: [Gitlab Permissions and roles](https://docs.gitlab.com/ee/user/permissions.html)
