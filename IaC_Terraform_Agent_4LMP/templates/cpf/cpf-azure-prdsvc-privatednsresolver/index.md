...
This terraform module creates an Azure Private DNS Resolver. Azure DNS Private Resolver is a service that enables queries to Azure DNS private zones from an on-premises environment and vice versa without deploying VM based DNS servers.

## Prerequisites

- `Resource Group` name is required.
- `Virtual Network ID` is required.

## Guidance

#### Usage

This Module is only creating the Private DNS resolver and refer other private dns resolver modules for endpoint and rulesets.
...
> Note: Currently, as per LSEG Approved private DNS resolver Security Requirements, there are no security requirements for this product.
...
- [azure-prdsvc-terraform-privatednsresolver](CHANGELOG.md)

## References

### Microsoft Docs

- [Azure Private DNS Resolver](https://learn.microsoft.com/en-us/azure/dns/dns-private-resolver-get-started-portal)
...
| Name | Description |
|------|-------------|
| <a name="output_id"></a> [id](#output_id) | The Resource ID of the Private DNS Resolver. |
| <a name="output_name"></a> [name](#output_name) | The Name of the Private DNS Resolver. |
| <a name="output_resource"></a> [resource](#output_resource) | The Private DNS Resolver resource. |
<!-- END_TF_DOCS -->
